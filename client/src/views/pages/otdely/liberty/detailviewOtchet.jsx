...
export default function DetailListLiberty() {

    const [datas, setViewOtchet] = useState([])
        ...
        <div>
            {selectedData ? (
                <div>
                    ...
                    <PercentUI />
                    <table key={selectedData._id} className='"lg:min-w-full w-full lg:text-[11px] text-[5px] bg-white  text-center'>
                        <thead className='bg-gradient-to-r from-pink-400 to-red-500 text-white'>
                            <tr>
                    ...
                    <table className="bg-white mx-auto mt-10 mb-10 lg:min-w-full w-[300px]  lg:text-[12px] text-[5px] text-center">
                        <thead className="bg-gradient-to-r from-pink-400 to-red-500 text-white">
                            <tr>
                            ...
                            selectedData.itog.map((elem, index) => {
                                return (
                                    <tbody key={elem._id} className='lg:text-[12px] text-[5px]'>
                                        ...
                                        <tr>
                                            <td colSpan='2' className='bg-gradient-to-r from-pink-400 to-red-500 text-white'>итоги</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colSpan='2' className='bg-gradient-to-r from-pink-400 to-red-500 font-semibold p-2 text-sm text-white'>общий итог: {elem.itogs} </td>
                                        </tr>
                                    </tbody>
                                )
                            })
